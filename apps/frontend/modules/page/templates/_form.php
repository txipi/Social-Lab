...
<div>
  ...
  <div>
    <div class="float_l"><strong><?php echo $form['description']->renderLabel() ?></strong> <?php echo $form['description']->renderError() ?></div>
    <div class="cleaner"></div>
    <br />
    <div><?php echo $form['description'] ?></div>
  </div>
  <br />
  <div>
    ...
    <div class="cleaner"></div>
    <br />
    <div class="alignright"><?php echo $form['photo'] ?></div>
    <div class="cleaner"></div>
  </div>
  <br />
